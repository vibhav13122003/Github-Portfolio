      ...
      <div className='flex'>
        ...
        <div className=' absolute pt-32 mt-28 max-md:px-4 ml-4 md:ml-12'>
          ...
          <p className='relative z-1 text-[24px] md:text-[28px]  lg:text-[32px] leading-[30px] md:leading-[36px] lg:leading-[44px] mb-5 md:mb-12 md:10/12  lg:w-9/12 text-[#7d8590]'>
            ...
            bhartiya a web developer focused on building innovative and
            impactful solutions which may or may not work but probably work most
            of the times. Explore my work and let&apos; create something amazing
            together with&nbsp;love.
          </p>
          ...
          <div className='md:my-32 my-24'>
            ...
            <div className='flex flex-wrap justify-centre items-center'>
              <img
                src='/text-1727286043598.png'
                alt='Family logo'
                height='44'
                className='my-3 scale-90'
              />
              <img
                src='/text-1727286143569.png'
                alt='Friends logo'
                height='44'
                className='my-3 scale-90'
              />
