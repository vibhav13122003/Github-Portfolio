          ...
          <div className='py-4 mb-2 w-full'>
            ...
            >
              <h2 className='mb-4 text-2xl max-lg:text-[20px] max-md:w-10/12 lg:w-full w-full text-[#7d8590]'>
                ...
                You can quickly get in touch in with me via gmail,
                instagram,facebook or linkedin account
              </h2>
              <a
            ...
            <div className='relative'>
              <div className='relative'>
                <div className='md:absolute z-[1] top-[-100px] lg:top-[-200px] right-0 shadow-2xl'>
                  <img
                    src='https://lh3.googleusercontent.com/Wsd5X6aeMI7LTuaVqbSaP_jhfFkuR370WxSK6zj1EAvRQ_MjHyqIu2pg1l7Tg8ZqtQ7jqMoBcZF7VTpN-PX82raE5-E=s1280-w1280-h800'
                    alt=''
                    loading='lazy'
                    decoding='async'
                    width='1190'
