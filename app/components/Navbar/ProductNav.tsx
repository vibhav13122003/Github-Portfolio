        ...
        <div className='lg:px-4 lg:border-r-[1px] mb-4 lg:mb-0 lg:pr-10  '>
          <ul className='max-lg:pl-6'>
            <li className=''>
              <Navlist
                main='Arcade'
                submain='AR based learning platform'
                path2=''
            ...
            <li className=''>
              <Navlist
                ...
                submain='A full stack Hospital Management'
                path2=''
            ...
            <li className=''>
              <Navlist
                main='Nasa-web'
                submain='A full stack Nasa mission Planner'
                ...
                href='https://github.com/vibhav13122003/Nasa-Project'
              />
            </li>
            <li className=''>
              <Navlist
                main='Barter-System'
                submain='A full stack barter system for trade of goods'
            ...
            <li>
              <Navlist
                main='Ambuvians'
                submain='A ambulance provider service'
                ...
                href='https://github.com/vibhav13122003/ambuvians'
              />
            </li>

            <li>
              <Navlist
                main='Smart ai canvas'
                submain='Smart canvas using ai'
