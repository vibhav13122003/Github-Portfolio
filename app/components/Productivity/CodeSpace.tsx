      ...
      <div className='lg:pl-24 md:pl-16 pl-6'>
          ...
          <div className='py-4 mb-2 w-full'>
            ...
            >
              <h2 className='mb-4 text-2xl max-lg:text-[20px] max-md:w-10/12 lg:w-full w-full text-[#7d8590]'>
                <span className='font-semibold text-white'>We</span> offer a
                complete dev environment , so you can make, build, test, and
                host website anywhere.
              </h2>
              <a
        ...
        >
          <div className='py-4 text-left'>
            ...
            <p className='mb-3 md:text-xl  text-lg text-white'>
              in productivity <br /> with us<sup>1</sup>
            </p>
          </div>
        </motion.div>
      </div>
