      ...
      <div className='flex items-center justify-between border-b-[0.5px] border-[#30363d] p-4'>
        ...
        <div className='flex items-center justify-between px-2 py-1 rounded-md bg-[#0d1117] border-[0.5px] border-[#30363d] w-full md:w-auto'>
          ...
          <div className='md:px-8 px-2 text-white whitespace-nowrap overflow-hidden text-[14px] text-ellipsis'>
            https://github.com/vibhav13122003
          </div>
          <svg
            aria-hidden='true'
            height='16'
        ...
        <div className='min-w-0 w-full'>
          ...
          <div className='p-4 text-[#7d8590]'>
            ...
            >
              ...
              >
                [<span className='color-fg-subtle'>06:09:42</span>]
                <span> Starting </span>
                &apos;
                <span className='color-fg-accent'>
                  watch-extension&apos;:
                  <span className='pl-e font-bold'>Skills</span>
                </span>
                ...
              </motion.div>
              <motion.div
              ...
              >
                ...
                &apos;
                <span className='color-fg-accent'>
                  Know-extension-languages&apos;:
                  <span className='text-white'>C,Java,Python</span>
                </span>{" "}
                after
              ...
              >
                ...
                &apos;
                <span className='color-fg-accent'>
                  Know-extension-library&apos;:
                  <span className='text-white'>React,Socket.io</span>
                </span>{" "}
                after
              ...
              >
                ...
                &apos;
                <span className='color-fg-accent'>
                  Know-extension-framework-&apos;:
                  <span className='text-white'>BootStrap,Express</span>
                </span>
                ...
              </motion.div>
              <motion.div
                ...
                className='no-wrap js-type-row row-is-visible'
              >
                [<span className='color-fg-subtle'>06:09:44</span>]
                <span> Finished </span>
                &apos;
                <span className='color-fg-accent'>
                  Know-extension&apos;:
              ...
              <motion.div
                ...
                className='no-wrap js-type-row row-is-visible'
              >
                [<span className='color-fg-subtle'>06:09:45</span>]
                <span> Finished </span>
                &apos;
                <span className='color-fg-accent'>
                  Other-skills&apos;:
                  <span className='text-white'>VsCode,Docker,Canva</span>
                </span>{" "}
                after
