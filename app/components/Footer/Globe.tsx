...
export function Globe() {
  ...
  return (
    <div className='flex flex-row items-center justify-center  h-screen md:h-auto  relative w-full md:mb-0 -mb-96'>
      <img
        alt=''
        aria-hidden='true'
        width='100%'
      ...
      />
      <div className='max-w-7xl mx-auto w-full relative  h-[90%] md:h-[40rem] px-4'>
        <motion.div
          initial={{
            opacity: 0,
            y: 20,
        ...
        <Meteors number={13} />
        <div className='absolute w-full md:-bottom-20 h-72 md:h-full z-10 h-1/2'>
