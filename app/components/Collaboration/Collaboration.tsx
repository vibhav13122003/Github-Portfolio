...
const Collaboration = (props: Props) => {
  ...
  return (
    <div className='max-w-[1280px] mx-auto'>
      <div className='flex md:pl-7 space-x-3 md:space-x-10'>
        ...
        >
          ...
          >
            ...
            We provide Web design, best-in-class websites, and the world’s most
            powerful developer tools in your project.
          </h3>
        </motion.div>
      </div>
      <h3
        className='text-[28px] md:text-[40px] max-md:leading-8 max-lg:leading-10 lg:text-5xl mb-7 font-medium text-white js-build-in-item build-in-slideX-left build-in-animate lg:ml-16 '
        style={{ transitionDelay: "300ms" }}
      >
        <span className='text-[#ffa28b]'>My Projects.</span>
        These are my projects which i worked upon
      </h3>
          ...
          <div className='flex flex-wrap justify-between gap-3'>
              ...
              >
                <div className='md:flex flex-col  flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 '>
                  <p className=' text-xl md:text-2xl mb-6 font-medium text-[#7d8590]'>
                    ...
                    can explore various concepts with the help of 3D Models,
                    enhancing their understanding and making learning more
              ...
              >
                <div className='md:flex flex-col  flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 '>
                  <p className=' text-xl md:text-2xl mb-6 font-medium text-[#7d8590]'>
                    ...
                    is a Ai powered canvas which can process the image and then
                    give the ouput accordingly the process image making learning
                    fun and more easy
                  </p>
                  <div>
                    <a
                      onMouseEnter={() => setHovered1(true)}
                      onMouseLeave={() => setHovered1(false)}
                      href='https://github.com/vibhav13122003/AI-canvas'
                      className='py-1 inline-block text-xl text-white font-semibold'
                    >
                      Check out pull request
                      <svg
              ...
              >
                <div className='md:flex flex-col  flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 '>
                  <p className=' text-xl md:text-2xl mb-6 font-medium text-[#7d8590]'>
                    ...
                    is ambulance providing service which provides ambulance in
            ...
            <div className='flex flex-col w-full md:w-[48%] '>
              ...
              >
                <div className='md:flex flex-col  flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 '>
                  <p className=' text-xl md:text-2xl mb-6 font-medium text-[#7d8590]'>
                    ...
                    It is a full stack hostpital management where patients can
                    book the appointments.There is also master admin which can
                    controls the appointment form and also manages doctors
                  </p>
                  <div>
                    <a
                      onMouseEnter={() => setHovered1(true)}
                      onMouseLeave={() => setHovered1(false)}
                      href='https://github.com/vibhav13122003/Hospital-management'
                      className='py-1 inline-block text-xl text-white font-semibold'
                    >
                      Check out pull request
                      <svg
              ...
              >
                <div className='md:flex flex-col  flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 '>
                  <p className=' text-xl md:text-2xl mb-6 font-medium text-[#7d8590]'>
                    <span className='text-[#79c0ff] font-semibold'>
                      Barter System
                    </span>{" "}
                    is a items trading platform where users can trade their
                    items for other items worth more or less similar.It promotes
                    resuability of items
                  </p>
                  <div>
                    <a
                      onMouseEnter={() => setHovered1(true)}
                      onMouseLeave={() => setHovered1(false)}
                      href='https://github.com/vibhav13122003/BarterSystem'
                      className='py-1 inline-block text-xl text-white font-semibold'
                    >
                      Check out pull request
                      <svg
              ...
              >
                <div className='md:flex flex-col  flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 '>
                  <p className=' text-xl md:text-2xl mb-6 font-medium text-[#7d8590]'>
                    <span className='text-[#d2a8ff] font-semibold'>
                      Portfolio
                    </span>{" "}
                    this is my first portfolio website made by React and css
                  </p>
                  <div>
                    <a
                      onMouseEnter={() => setHovered1(true)}
                      onMouseLeave={() => setHovered1(false)}
                      href='https://github.com/vibhav13122003/PortFolio'
                      className='py-1 inline-block text-xl text-white font-semibold'
                    >
                      Check out pull request
                      <svg
      ...
      <h3
        className='text-[28px] md:text-[40px] max-md:leading-8 max-lg:leading-10 lg:text-5xl mb-7 font-medium text-white js-build-in-item build-in-slideX-left build-in-animate lg:ml-16 md:mt-8'
        style={{ transitionDelay: "300ms" }}
      >
